	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" method="POST" action="<?php echo base_url()?>/index.php/c_praktikum/createpenghuni">
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Unit is required">
						<input class="input100" type="text" name="unit" >
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-36" data-validate = "Nomor KTP is required">
						<input class="input100" type="text" name="noktp" >
						<span class="focus-input100"></span>
					</div>
